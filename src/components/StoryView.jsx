  ...
  return (
    <div style={{width:380, background:'var(--bg-surface)', borderRight:`1px solid ${SV.divider}`, display:'flex', flexDirection:'column', overflow:'hidden'}}>
      ...
      <div style={{padding:'14px 24px', borderTop:`1px solid ${SV.divider}`, background:'var(--bg-surface)', display:'flex', gap:8, alignItems:'center'}}>
        ...
        >{t('story.prev')}</div>
        {idx === total - 1 ? (
          <div onClick={onRestart} style={{flex:1, padding:'7px 14px', borderRadius:8, fontSize:12, fontWeight:600, background:primaryColor, color:'#111827', cursor:'pointer', textAlign:'center', userSelect:'none'}}>{t('story.restart')}</div>
        ) : (
          <div onClick={onNext} style={{flex:1, padding:'7px 14px', borderRadius:8, fontSize:12, fontWeight:600, background:primaryColor, color:'#111827', cursor:'pointer', textAlign:'center', userSelect:'none'}}>{t('story.next')}</div>
        )}
      </div>
